...
var miArray = require('../Person.js').Person;
describe("About Arrays", function() {
    ...
    it("should understand array length", function() {
        ...
        expect(tenEmptyElementArray.length).to.equal(1);
    ...
    it("should slice arrays", function() {
        ...
        expect(array.slice(2, 2).toString()).to.equal("and");
        expect(array.slice(2, 20).toString()).to.equal("and", "jelly", "-1");
        expect(array.slice(3, 0).toString()).to.equal("jelly", "and", "peanut");
        expect(array.slice(3, 100).toString()).to.equal("jelly", "-1");
        expect(array.slice(5, 1).toString()).to.equal("-1", "jelly", "and", "butter");
    });
    ...
    it("should know about shifting arrays", function() {
        ...
        expect(shiftedValue).to.equal(-1);
        expect(array.toString()).to.equal("-1");
    });
});